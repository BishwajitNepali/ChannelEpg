...
public class ShowGridAdapter2 extends ArrayAdapter<ShowsInChannel> {
	private final Activity context;
	private final ArrayList<ShowsInChannel> channelList;

	public ShowGridAdapter2(Activity context, ArrayList<ShowsInChannel> channelList) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		try {
			...
			Title.setText(channelList.get(position).getShowName());
